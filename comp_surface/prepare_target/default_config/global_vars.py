...
os.environ['MSMS_BIN']= "/app/SurfDock/comp_surface/tools/msms_i86_64Linux2_2.6.1/msms.x86_64Linux2.2.6.1"
...
os.environ['PDB2PQR_BIN']="/app/SurfDock/comp_surface/tools/transfer/pdb2pqr-linux-bin64-2.1.1/pdb2pqr"
if 'PDB2PQR_BIN' in os.environ:
  ...
  sys.exit(1)
os.environ['APBS_BIN']="/app/SurfDock/comp_surface/tools/transfer/APBS-3.4.1.Linux/bin/apbs"
if 'APBS_BIN' in os.environ:
   apbs_bin = os.environ['APBS_BIN']
else:
  print("ERROR: APBS_BIN not set. Variable should point to APBS program.")
  sys.exit(1)
os.environ['MULTIVALUE_BIN']="/app/SurfDock/comp_surface/tools/transfer/APBS-3.4.1.Linux/share/apbs/tools/bin/multivalue"
